...
Founder of [**zahrcast**](https://zahrcast.com), which provides Bayesian forecasting for oncology trials in flight. Economist and applied Bayesian statistician with 10+ years building **hierarchical models** for **longitudinal and survival data**. Previously at AstraZeneca, building **patient-level digital-twin models** of oncology tumor dynamics with real-world evidence integration. Earlier work spans field experiments in East Africa and South Asia, real-estate market design, and health-behavior interventions.
...
Bayesian forecasting for oncology trials in flight: joint models of tumour dynamics and multistate survival that forecast what a trial will report at maturity from immature interim data, partially pooling historical trials, to support go/no-go and other interim decisions.
