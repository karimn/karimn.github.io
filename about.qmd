...
I run [[zahrcast]{.zahrcast}](https://zahrcast.com), which provides Bayesian forecasting for oncology trials in flight. I am an economist and applied Bayesian statistician, and I have spent over 10 years building hierarchical models for longitudinal and survival data. At AstraZeneca I built patient-level models of oncology tumor dynamics that integrated real-world evidence. Before that I worked on field experiments in East Africa and South Asia, real-estate market design, and health-behavior interventions.
...
::: {.d-flex .justify-content-between}
::: {}
Principal — *[[zahrcast]{.zahrcast}](https://zahrcast.com)*
:::
::: {.text-end}
Jul 2026 — present
:::
