...
Founder, Zahrcast | Economist \& Bayesian Statistician\\[1mm]
...
Economist and applied Bayesian statistician with 10+ years building \textbf{hierarchical models} for \textbf{longitudinal and survival data}. Founder of Zahrcast, forecasting oncology trial outcomes from immature interim data. Previously at AstraZeneca, building \textbf{patient-level digital-twin models} of oncology tumor dynamics with real-world evidence integration; earlier work spans field experiments in East Africa and South Asia, real-estate market design, and health-behavior interventions.
...
\textbf{Founder} | \textit{Zahrcast LLC} \hfill Jul 2026 -- present
\begin{itemize}
