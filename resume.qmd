...
Barker, Davis, López-Peña, Mitchell, Mobarak, Naguib, Reimão, Shenoy, and Vernot, "Migration and Resilience during a Global Crisis," *European Economic Review* (accepted); two additional working papers on migration at scale (Bangladesh) and optimal incentives under social norms (Kenya); Naguib et al., "Bayesian joint modelling of mechanistic tumour growth and time-to-event endpoints for dynamic prediction of ongoing oncology trials" (in preparation).
